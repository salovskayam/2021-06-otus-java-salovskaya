...
public class UsersWebServerImpl implements UsersWebServer {
    ...
    public UsersWebServerImpl(int port, Gson gson, TemplateProcessor templateProcessor,
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new ClientsApiServlet(gson, dbServiceClient)), "/api/client");
